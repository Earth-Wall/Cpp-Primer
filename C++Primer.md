...
【swap()交换除array之外其他的容器的速度】很快，【swap()】不交换【元素】，【swap()】交换【容器的内部数据结构】。

【swap()】不拷贝、删除、插入【除array之外其他的容器的元素】，【swap()】交换【两个除array之外其他的容器的元素】是【常量阶】。

因为【swap()】不会移动【除array之外其他的容器的元素】，所以在调用【swap()】之后，【除string之外其他的容器的迭代器、引用、指针】不会失效。
虽然【除string之外其他的容器的迭代器、引用、指针】仍然指向【之前指向的元素】。
...
【C++11的标准库】的【.insert()】，如果【插入范围】不为空，那么返回【指向第一个新元素的迭代器】，如果【插入范围】为空，那么返回【插入位置的迭代器】。
